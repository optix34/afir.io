Ext.define('Store.m25_monitor.view.MainPanel', {
    ...
    initComponent: function() {
        ...
        this.loadingMask = new Ext.LoadMask(this.getEl(), { msg: l('Загрузка...') });
    },
                ...
                afterrender: function() {
                    ...
                    if (iframeDom) {
                        ...
                        iframeDom.onerror = function() {
                            me.loadingMask.hide();
                            Ext.Msg.alert(l('Ошибка'), l('Не удалось загрузить страницу. Возможно, сайт запрещает встраивание в iframe.'));
                        };
                    }
                }
            }
    ...
    createToolbar: function() {
        ...
        this.toolbar = Ext.create('Ext.toolbar.Toolbar', {
            ...
            items: [
                ...
                {
                    text: l('Открыть в безопасном режиме'),
                    iconCls: 'fa fa-shield-alt',
                    tooltip: l('Открыть страницу в новой вкладке, если iframe заблокирован'),
                    handler: function() {
                        if (me.currentIframeSrc && me.currentIframeSrc !== 'about:blank') {
                            window.open(me.currentIframeSrc, '_blank');
                            Ext.Msg.notification(l('Внимание'), l('Страница открыта в новом окне из-за ограничений безопасности.'));
                        }
                    }
                },
                '->',
